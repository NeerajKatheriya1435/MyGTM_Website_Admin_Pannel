...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const res = await axios.post(`${process.env.REACT_APP_API}/api/v1/user/loginUser`, loginForm);
            ...
            <div className='formContainer'>
                <form className='inputFormContainer' onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <button onClick={() => { navigate("/forgot-password") }} className="btn btn-success mx-2">Reset Password</button>
                    </div>
                </form>
